/// INSTALL
/// npm install atob express  body-parser  cookie-parser multer ejs mongodb mongoose  express-session cookie-session qrcode  qrcode-svg  --save
...
function createUserPage(req, res) {
    if (session.user) {
        if (req.query.username && req.query.username.trim() != "") {
            ...
            libDB.res_insertDB(MongoClient, urldb, "Shoplego", "user",
...
let transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: email , // abcdeyzryud123@gmail.com
        pass: password // TODO: your gmail password P12345678
    }
});
let mailOptions = {
    from: email, // TODO: email sender
    to: 'chauruby2000@gmail.com' , // TODO: email receiver
    subject: subject,
